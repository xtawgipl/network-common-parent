...
/**
 * @author zhangjj
 * @create 2017-11-21 10:04
 **/
@Configuration
@ConfigurationProperties(prefix="nettyx.server")
public class NettyxServerProperties {

    /** 服务器端监听 ip，默认为127.0.0.1 */
    ...
    /** 服务器端超时时间，读消息超时时间 超过该时间未读取到消息则服务器端主动断开连接（单位 秒），值小于等于0则表示 无限大*/
    private Integer readTimeout;

    /** 服务器端超时时间，写消息超时时间 超过该时间没有写消息则服务器端主动断开连接（单位 秒），值小于等于0则表示 无限大*/
